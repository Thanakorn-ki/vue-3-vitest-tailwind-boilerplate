<template>
  <div class="about">
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
      <img src="https://picsum.photos/200/300?grayscale" alt="" class="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2"
        width="1308" />
      <div
      ...
      <div
        ...
        <div class="mx-auto max-w-md">
          <img src="https://picsum.photos/id/237/536/354" class="h-6" alt="Tailwind Play" />
